...
function App() {
  return (
    <Routes>
      ...
      <Route path="/linkedin" element={<RedirectContainer title="LinkedIn" url="https://linkedin.com/in/jc-hiroto" />} />
      <Route path="/github" element={<RedirectContainer title="GitHub" url="https://github.com/jc-hiroto" />} />
      <Route path="/twitter" element={<RedirectContainer title="Twitter" url="https://twitter.com/jc_hiroto_" />} />
